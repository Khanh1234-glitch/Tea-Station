...
import type { Benefit, BestSeller, BestSellerProduct } from "../Model/BestSeller.js";
...
export class HomeView {
    ...
    renderFeature(feature: Feature): string {
        const getItem = (pos: string) => feature.item.find((i) => i.position === pos);
    ...
    `;
        ...
        const renderProduct = (product: BestSellerProduct) => {
